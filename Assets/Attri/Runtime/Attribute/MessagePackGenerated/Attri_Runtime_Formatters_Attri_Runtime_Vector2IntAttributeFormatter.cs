...
namespace Attri.Runtime.Formatters.Attri.Runtime
{
    public sealed class Vector2IntAttributeFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Attri.Runtime.Vector2IntAttribute>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Attri.Runtime.Vector2IntAttribute value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Collections.Generic.List<global::Attri.Runtime.FrameData<global::UnityEngine.Vector2Int>>>(formatterResolver).Serialize(ref writer, value.frames, options);
        }
        ...
        public global::Attri.Runtime.Vector2IntAttribute Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var __frames__ = default(global::System.Collections.Generic.List<global::Attri.Runtime.FrameData<global::UnityEngine.Vector2Int>>);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 6:
                        ...
                        __frames__ = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Collections.Generic.List<global::Attri.Runtime.FrameData<global::UnityEngine.Vector2Int>>>(formatterResolver).Deserialize(ref reader, options);
                        continue;

                }
            }

            var ____result = new global::Attri.Runtime.Vector2IntAttribute(__name__);
