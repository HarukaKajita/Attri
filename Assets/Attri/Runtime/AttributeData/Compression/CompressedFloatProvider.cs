...
namespace Attri.Runtime
{
	public class CompressedFloatProvider : CompressedDataProvider
	{
		...
		// 	{
		// 		var frameCount = _compressedValueBytes.Length;
		// 		var result = new float[frameCount][][];
		// 		for (var i = 0; i < frameCount; i++)
		// 		{
		// 			var attribute = _compressedValueBytes[i];
		// 			var elementCount = attribute.Length;
		// 			result[i] = new float[elementCount][];
		// 			for (var j = 0; j < elementCount; j++)
		// 			{
		// 				var components = attribute[j];
		// 				var componentCount = components.Length;
		// 				for (var k = 0; k < componentCount; k++)
		// 				{
		// 					var floatValue = System.BitConverter.ToSingle(components[k].Value, 0);
		// 					result[i][j][k] = floatValue;
		// 				}
		// 			}
		// 		}
		// 		return result;
